...
const WEB_SPEECH_SNIPPET = `"use client";
...
export function VoiceInputCodeExample() {
  const data = [
    {
      language: "tsx",
      filename: "web-speech.tsx",
      code: WEB_SPEECH_SNIPPET,
    },
  ];

  return (
    <CodeBlock data={data} defaultValue="tsx" className="w-full">
      <CodeBlockHeader className="px-2">
        <CodeBlockFiles className="gap-1">
          {({ filename, language }) => (
      ...
      <CodeBlockBody>
        {({ code, language }) => (
          ...
          >
            <CodeBlockContent language="tsx">{code}</CodeBlockContent>
          </CodeBlockItem>
        )}
      </CodeBlockBody>
    </CodeBlock>
